...
function MarketPlace() {
  return (
    <main className='relative mt-16 h-full flex bg-[#edeffe]'>
...
{/* <img src={Vector1} className="hidden sm:block w-26 h-6" alt="logo" />
<img src={UX} className="hidden sm:block w-26 h-6" alt="logo" />
<img src={Graphics} className="hidden sm:block w-26 h-6" alt="logo" />
<img src={Illu} className="hidden sm:block w-26 h-6" alt="logo" />
<img src={Unreal} className="hidden sm:block w-26 h-6" alt="logo" />
<img src={Cenima} className="hidden sm:block w-26 h-6" alt="logo" /> */}